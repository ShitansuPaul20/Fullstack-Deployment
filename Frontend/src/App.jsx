...
const App = () => {
  ...
  function fetchNotes(){
    axios.get("https://fullstack-deployment-i389.onrender.com/notes").then((res)=>{
 ...
 function submitHandler(e){
    ...
    axios.post("https://fullstack-deployment-i389.onrender.com/notes",{
      title: title.value,
 ...
 function deleteNote(noteId){
    axios.delete("https://fullstack-deployment-i389.onrender.com/notes/"+noteId)
    .then((res)=>{
      console.log(res.data.message)
      fetchNotes()
    })
 ...
 function updateNote(noteId){
    ...
    axios.patch("https://fullstack-deployment-i389.onrender.com/notes/"+noteId,{
      description : update
    })
    .then((res)=>{
      console.log(res.data.message)
